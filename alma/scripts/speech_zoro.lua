...
return {
	...
	ANNOUNCE_BEES = "abelhas malditas .",
	ANNOUNCE_BOOMERANG = "...I prefer my swords.",
	ANNOUNCE_CHARLIE = "What was that?!",
	ANNOUNCE_CHARLIE_ATTACK = "OW! Something bit me!",
	ANNOUNCE_COLD = "ta um friozin gostoso..",
	ANNOUNCE_CRAFTING_FAIL = "Someone forgot to get all the ingredients.",
	ANNOUNCE_DEERCLOPS = "Something want to fight?",
	ANNOUNCE_DUSK = "alma god.",
	ANNOUNCE_EAT =
	{
		GENERIC = "huuum, gostoso.",
		PAINFUL = "que porcaria foi essa que eu comi...",
		SPOILED = "...",
		STALE = "...",
	},
	ANNOUNCE_ENTER_DARK = "TA FICANDO ESCURO NEGADA.",
	ANNOUNCE_ENTER_LIGHT = "A LUZ CHEGOU",
	ANNOUNCE_FREEDOM = "liberdade cantou!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "US CACHORRO TAO VINDO NEGADAA.",
	ANNOUNCE_HUNGRY = "DISGRAÇAAAAAAA,  QUE FOME.",
	...
	ANNOUNCE_QUAKE = "TERREMOTOOOOOOOOOOOOO.",
	...
	{
		GENERIC = "XATOMAAA!",
		PIG = "VAI TOMANDO PORQUINHO!",
		PREY = "XORA LIXO!",
		SPIDER = "XATOMAAA!",
		SPIDER_WARRIOR = "XATOMA DO ALMA!",
	},
	COMBAT_QUIT =
	{
	...
	DESCRIBE =
	{
        PLAYER =
        {
            ...
            GHOST = "%s virou fantasma, meio trolhos",
        },
		WILSON = 
		{
			GENERIC = "It's Wilson!",
