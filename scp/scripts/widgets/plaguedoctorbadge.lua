...
local plaguedoctorbadge = Class(Badge, function(self, owner)
    Badge._ctor(self, "health", owner)
    self.anim:GetAnimState():SetBuild("plaguedoctorbadge")
    self.owner = owner
...
function plaguedoctorbadge:OnGainFocus()
...
function plaguedoctorbadge:OnLoseFocus()
