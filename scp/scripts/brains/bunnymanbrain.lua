...
local BUNNY_TALK_SCP_RUNAWAY  = {"NO!", "HELP!", "DEATH!"} 
...
function BunnymanBrain:OnStart()
    ...
    local root = 
        PriorityNode(
        {
            ...
            ChattyNode(self.inst,BUNNY_TALK_SCP_RUNAWAY ,RunAway(self.inst, "scp049", 3, 6)),
            ChattyNode(self.inst,BUNNY_TALK_SCP_RUNAWAY ,RunAway(self.inst, "scp049", 6, 12, nil, true)),   
