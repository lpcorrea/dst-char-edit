...
local PIG_TALK_SCP_RUNAWAY  = {"SCARY BEAK MAN!", "AAAAAHHH!!!", "NO NO NO!!"} 
...
function PigBrain:OnStart()
    ...
    local root =
        PriorityNode(
        {
            ...
            ChattyNode(self.inst,PIG_TALK_SCP_RUNAWAY ,RunAway(self.inst, "scp049", 3, 6)),
            ChattyNode(self.inst,PIG_TALK_SCP_RUNAWAY ,RunAway(self.inst, "scp049", 6, 12, nil, true)),   
