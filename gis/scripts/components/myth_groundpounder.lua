                ...
                if dodamage then
                    for i, v2 in ipairs(ents) do
                        if v2 ~= self.inst and
                            ...
                            if  self.inst.owner ~= nil and self.inst.owner.components.combat:CanTarget(v2) and v2.components.combat   then
                                v2.components.combat:GetAttacked(self.inst.owner,200, nil, "mk_striker")
                            elseif self.inst.components.combat:CanTarget(v2) then
