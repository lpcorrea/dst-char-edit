...
local COLOUR_ENVELOPE_NAME_EMBER = "mk_dsf_fx_small_ember_colour"
local SCALE_ENVELOPE_NAME_EMBER = "mk_dsf_fx_small_ember_scale"
...
local function InitEnvelope()
    ...
    local ember_max_scale = 1.3--0.8 --.55
...
return Prefab("mk_dsf_fx_small", fn, assets)